...
async def test_sub_iteration_middleware():
    ...
    judge.assess.return_value = JudgeAssessment(
        details=AssessmentDetails(
            mechanism_score=10, mechanism_reasoning="Good reasoning text here",
            clinical_evidence_score=10, clinical_reasoning="Good reasoning text here",
            drug_candidates=[], key_findings=[]
        ),
        sufficient=True,
        confidence=1.0,
